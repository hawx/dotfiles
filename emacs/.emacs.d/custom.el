(custom-set-variables
 ...
 '(beacon-dont-blink-commands
   (quote
    (next-line previous-line forward-line recenter-top-bottom)))
 '(beacon-mode t)
 '(custom-safe-themes
   (quote
